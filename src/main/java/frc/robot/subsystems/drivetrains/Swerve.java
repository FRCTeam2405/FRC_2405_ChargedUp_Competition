...
public class Swerve extends SubsystemBase {
  ...
  public Swerve() {
    ...
    frontLeftSwerveModule = new SwerveModule(
      ...
      Constants.Drivetrains.Swerve.Motors.Driving.FRONT_LEFT_PORT,
    ...
    frontRightSwerveModule = new SwerveModule(
      ...
      Constants.Drivetrains.Swerve.Motors.Driving.FRONT_RIGHT_PORT,
    ...
    backLeftSwerveModule = new SwerveModule(
      ...
      Constants.Drivetrains.Swerve.Motors.Driving.BACK_LEFT_PORT,
    ...
    backRightSwerveModule = new SwerveModule(
      ...
      Constants.Drivetrains.Swerve.Motors.Driving.BACK_RIGHT_PORT,
