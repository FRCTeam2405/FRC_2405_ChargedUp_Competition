...
public class PlaceMobilityDock extends SequentialCommandGroup {
  /** Creates a new PlaceMobilityDock. */
  public PlaceMobilityDock(SwerveContainer swerve, Arm arm, Grip grip, Lights lights) {
