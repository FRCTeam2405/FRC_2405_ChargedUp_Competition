...
public class TeleopDrive extends CommandBase
{
  ...
  private final SwerveContainer  swerve;
   ...
   */
  public TeleopDrive(SwerveContainer swerve, DoubleSupplier vX, DoubleSupplier vY, DoubleSupplier omega,
  ...
  public void execute()
  {
    ...
    } else
    {
      ...
      swerve.driveRaw(new Translation2d(xVelocity * controller.config.maxSpeed, yVelocity * controller.config.maxSpeed),
